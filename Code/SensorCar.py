...
class SensorCar(sc.SonicCar):
    ...
    def Fahrparcours_5(self):
        ...
        while dist_radar > 5 or dist_radar < 0:
            ...
            print(dist_radar)
            sens_werte = self.ir.read_digital() # z. B. [1, 1, 0, 1, 0]  
            # print(sens_werte)
    ...
    def Fahrparcours_6(self):
        ...
        while True:
            ...
            if self.lenkw_norm > 0:
                ...
                lenkwinkel = self.lenkw_max * (+1) + 90
            self.drive(20, -1, lenkwinkel) # Zuruecksetzen
            time.sleep(0.2) # Wieder Gegenlenken in vorherige Richtung fehlt noch.
            self.stop()
